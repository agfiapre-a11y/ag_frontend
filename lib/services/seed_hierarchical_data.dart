...
class SeedHierarchicalData {
  ...
  static Future<void> seedHierarchicalUsers(String churchId) async {
    ...
    final nationalAdmin = AppUser(
      ...
      passwordHash: AuthService.hashPassword('password123'),
      roles: [AppRoles.nationalAdmin], activeRole: AppRoles.nationalAdmin,
      churchId: churchId,
      branchId: '',
      organizationId: orgId,
    ...
    final regionalAdmin = AppUser(
      ...
      passwordHash: AuthService.hashPassword('password123'),
      roles: [AppRoles.regionalAdmin], activeRole: AppRoles.regionalAdmin,
      churchId: churchId,
      branchId: '',
      organizationId: orgId,
      regionId: regionId,
    ...
    final districtAdmin = AppUser(
      ...
      passwordHash: AuthService.hashPassword('password123'),
      roles: [AppRoles.districtAdmin], activeRole: AppRoles.districtAdmin,
      churchId: churchId,
      branchId: '',
      organizationId: orgId,
      regionId: regionId,
    ...
    final areaAdmin = AppUser(
      ...
      passwordHash: AuthService.hashPassword('password123'),
      roles: [AppRoles.areaAdmin], activeRole: AppRoles.areaAdmin,
      churchId: churchId,
      branchId: '',
      organizationId: orgId,
      regionId: regionId,
